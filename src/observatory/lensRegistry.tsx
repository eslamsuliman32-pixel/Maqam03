...
export const LENSES: LensMeta[] = [
  ...
  { id: 'constellation', label: 'سماء البارات',    icon: 'Sparkles', hint: 'خريطة التشابه السوني',        ready: false },
  { id: 'heatmap',       label: 'بصمة المخارج',    icon: 'Flame',    hint: 'حرارة مخارج النطق',           ready: false },
...
export const LENS_COMPONENTS: Partial<Record<LensId, React.LazyExoticComponent<React.ComponentType>>> = {
  // constellation: lazy(() => import('./lenses/ConstellationLens')),
  // heatmap:       lazy(() => import('./lenses/HeatmapLens')),
};
